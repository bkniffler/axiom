import type { CanvasKit, Canvas, Paint, RuntimeEffect, Shader } from 'canvaskit-wasm';
...
half4 main(float2 fragCoord) {
    ...
    return half4(half3(0.0), half(clamp(a * iFade, 0.0, 1.0)));
        ...
        this.effect = CK.RuntimeEffect.Make(sksl, (err) => console.warn('Blackout shader error:', err));
    ...
    draw(canvas: Canvas, params: BlackoutDrawParams): void {
        ...
        canvas.drawRect(this.CK.LTRBRect(0, 0, params.width, params.height), this.paint);
    }
