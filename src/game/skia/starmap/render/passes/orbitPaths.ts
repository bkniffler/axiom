...
function drawDottedCircle(renderer: PixelRenderer, cx: number, cy: number, radius: number, pixelSize: number, color: Rgb, opacity: number): void {
...
export function drawOrbitPaths(params: DrawOrbitPathsParams): void {
    ...
    for (const planet of params.planets) {
        ...
        drawDottedCircle(params.renderer, params.sunScreenX, params.sunScreenY, radius, params.pixelSize, orbitColor, 0.18);
    }
    for (const belt of params.belts) {
        ...
        drawDottedCircle(params.renderer, params.sunScreenX, params.sunScreenY, radius, params.pixelSize, orbitColor, 0.12);
    }
}
