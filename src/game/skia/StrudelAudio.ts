...
class StrudelAudioManager {
            ...
            switch (this.currentSoundtrack) {
                case 'first-light':
                    ...
                    stack(
                        ...
                        note("eb1 ~ ~ ~ ~ ~ ~ ~ bb0 ~ ~ ~ ~ ~ ~ ~ c1 ~ ~ ~ ~ ~ ~ ~ ab0 ~ ~ ~ ~ ~ ~ ~ eb1 ~ ~ ~ ~ ~ ~ ~ bb0 ~ ~ ~ ~ ~ ~ ~ g1 ~ ~ ~ ~ ~ ~ ~ ab0 ~ ~ ~ ~ ~ ~ ~")
                            .slow(64).sound("sawtooth").lpf(90).gain(0.13),

                        // === PAD: Rich orchestral chords (48-beat, phases beautifully) ===
                        // Full triads with 7ths - warm and enveloping
                        note("eb3 g3 bb3 ~ ~ ~ ~ ~ ~ ~ ~ ~ bb2 d3 f3 ~ ~ ~ ~ ~ ~ ~ ~ ~ c3 eb3 g3 ~ ~ ~ ~ ~ ~ ~ ~ ~ ab2 c3 eb3 ~ ~ ~ ~ ~ ~ ~ ~ ~")
                            .slow(48).sound("triangle").lpf(900).gain(0.04).room(0.88),
                        ...
                        note("~ ~ ~ ~ eb4 ~ g4 ~ bb4 ~ ~ ab4 g4 ~ eb4 ~ ~ ~ f4 ~ g4 ~ ab4 ~ bb4 ~ ~ c5 ~ bb4 ~ ab4 g4 ~")
                            .slow(32).sound("triangle").lpf(2200).gain(0.045).room(0.82).delay(0.15),

                        // === COUNTER MELODY: Answers the main theme (37-beat prime) ===
                        // Weaves around the melody, creating call and response
                        note("~ ~ bb4 ~ ~ ~ ~ c5 ~ ~ ~ ~ ~ bb4 ~ ~ ~ ab4 ~ ~ ~ ~ ~ ~ g4 ~ ~ ~ ~ ~ ~ f4 ~ ~ ~ ~ ~ ~")
                            .slow(37).sound("sine").lpf(2800).gain(0.025).room(0.85).pan(0.65),

                        // === HIGH STRINGS: Soaring sustains (29-beat prime) ===
                        // Long held notes that add grandeur
                        note("~ ~ ~ ~ ~ ~ ~ ~ ~ ~ eb5 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ bb4 ~ ~ ~")
                            .slow(29).sound("sine").lpf(3200).gain(0.018).room(0.92).delay(0.3),

                        // === MIDDLE VOICE: Harmonic fill (19-beat prime) ===
                        note("g4 ~ ~ ~ ~ ~ ab4 ~ ~ ~ ~ ~ ~ ~ bb4 ~ ~ ~ ~")
                            .slow(19).sound("triangle").lpf(1600).gain(0.02).room(0.8).pan(0.35),

                        // === BASS PULSE: Gentle rhythmic foundation (8-beat) ===
                        note("eb2 ~ ~ ~ bb1 ~ ~ ~")
                            .slow(8).sound("sine").lpf(150).gain(0.06).room(0.7),

                        // === SHIMMER: Highest register sparkle (23-beat prime) ===
                        note("~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ g5 ~ ~ ~ ~ ~ ~ bb5 ~ ~")
                            .slow(23).sound("sine").lpf(4500).gain(0.008).room(0.95).delay(0.45)
                    ).play();
                    break;
    ...
    nextSoundtrack(): string {
        const currentIndex = SOUNDTRACKS.findIndex(s => s.id === this.currentSoundtrack);
