import { SvgMenuStyle, MenuCallbacks } from './SvgMenu';
...
export class DataRainStyle extends SvgMenuStyle {
    ...
    protected createVisuals(): void {
        ...
        this.rainGroup = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    ...
    protected animate(): void {
        ...
        this.chars.forEach(char => {
            ...
            if (Math.random() < 0.005) {
                ...
                const flicker = char.opacity * (0.8 + 0.2 * Math.sin(time * 5 + char.x));
